    ...
    def ensure_demo_data(vendor):
        ...
        demo_products = [
            {
                ...
                'sku': 'MVP-MON-001',
                'category': categories['patient-care'],
                'price': '850.00',
                'stock_quantity': 12,
                'manufacturer': 'MedCore',
                'model_number': 'MC-PM100',
                'short_description': 'Portable 5-parameter monitor for clinics and emergency rooms.',
                'description': 'A reliable patient monitor for heart rate, SpO2, blood pressure, temperature and respiratory rate. Built for simple demo ordering and real clinic workflows.',
                'specifications': {'Display': '12 inch', 'Parameters': 'ECG, SpO2, NIBP, TEMP, RESP'},
                'is_featured': True,
            },
            {
                ...
                'price': '2450.00',
                'stock_quantity': 4,
                'manufacturer': 'SonoLite',
                'model_number': 'SL-U2',
                'short_description': 'Compact ultrasound scanner for point-of-care diagnosis.',
                'description': 'Lightweight ultrasound device suitable for maternal care, emergency assessment and mobile clinical teams.',
                'specifications': {'Probe': 'Convex', 'Battery': '3 hours', 'Connectivity': 'USB-C'},
                'is_featured': True,
            },
            {
                ...
                'sku': 'MVP-SUR-003',
                'category': categories['surgical-tools'],
                'price': '320.00',
                'stock_quantity': 25,
                'manufacturer': 'SafeCut',
                'model_number': 'SC-SET20',
                'short_description': 'Reusable stainless steel instrument kit for minor procedures.',
                'description': 'A practical set of forceps, scissors, clamps and holders for outpatient and theatre preparation.',
                'specifications': {'Pieces': '20', 'Material': 'Stainless steel', 'Sterilizable': 'Yes'},
                'is_featured': False,
            },
            {
                'name': 'Automatic Blood Pressure Machine',
                'slug': 'automatic-blood-pressure-machine',
                'sku': 'MVP-BP-004',
                'category': categories['diagnostics'],
                'price': '95.00',
                'stock_quantity': 40,
                'manufacturer': 'CarePulse',
                'model_number': 'CP-BP9',
                'short_description': 'Fast digital BP machine for triage and outpatient rooms.',
                'description': 'Easy-to-use automatic blood pressure monitor with cuff and memory for repeated checks.',
                'specifications': {'Cuff': 'Adult', 'Power': 'Battery/USB', 'Memory': '99 readings'},
                'is_featured': False,
            },
        ]
        ...
        for product in demo_products:
            Product.objects.get_or_create(
                slug=product['slug'],
                defaults={**product, 'vendor': vendor, 'condition': Product.Condition.NEW, 'is_active': True},
            )
