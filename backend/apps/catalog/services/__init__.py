...
class ProductService:
    ...
    def ensure_demo_data(vendor):
        ...
        for product in [
            ...
            {'name': 'Portable Ultrasound Scanner', 'slug': 'portable-ultrasound-scanner', 'sku': 'MVP-ULT-002', 'category': categories['diagnostics'], 'price': '2450.00', 'stock_quantity': 4, 'manufacturer': 'SonoLite', 'model_number': 'SL-U2', 'short_description': 'Compact ultrasound scanner for point-of-care diagnosis.', 'description': 'Lightweight ultrasound device suitable for maternal care and mobile clinical teams.', 'specifications': {'Probe': 'Convex', 'Battery': '3 hours', 'Connectivity': 'USB-C'}, 'is_featured': True},
